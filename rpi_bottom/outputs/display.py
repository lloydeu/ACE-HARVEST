...
Dark industrial UI - 1024x600 fullscreen - Waveshare 7" HDMI touch LCD
GStreamer appsink camera integration (Wayland compatible)

Install deps (once):
    sudo apt install python3-gi gir1.2-gstreamer-1.0 \
         gir1.2-gst-plugins-base-1.0 gstreamer1.0-libav \
...
class DisplayOutput:
    ...
    def _build_body(self):
        ...
        self.cam_frame = tk.Frame(body, bg='#090909',
                                   width=CAMERA_W, height=CONTENT_H)
        ...
        self.cam_label.place(x=0, y=0, width=CAMERA_W, height=CONTENT_H)
    ...
    def _build_overlay(self):
        """Telemetry overlay — bottom-left of camera."""
        OW, OH = 228, 110
        self.overlay_frame = tk.Frame(
            self.cam_frame, bg='#0a0a0a',
            highlightbackground=C['border'], highlightthickness=1)
        self.overlay_frame.place(x=8, y=CONTENT_H - OH - 8,
                                  width=OW, height=OH)
